...
Contact Details for the non profit, email - bargad.ngo@gmail.com , phone - +91 99111 97344, office - B- 59/C Shiv Park Khanpur , Delhi, India, Delhi
        ...
        const completion = await openai.chat.completions.create({
          ...
          messages: [
              { role: 'system', content: `You are a helpful assistant for a non-profit organization named Bargad Foundation and your name is WebSeva and you are created by Abhishek Kholiya. use the information provided to answer the questions. ${info} and only answer in maximum 2 lines` },
